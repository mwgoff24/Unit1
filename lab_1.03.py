...
Respond to the following:
    1. What happens?                                The program says dogs are really cool.
    2. How would you make the program print 
    out "cats are really cool" instead?             Type in animal = "cats"

2. In your Console / Terminal
Type and run the following code:
print(dogs + " are cool.")
In your Notebook
Respond to the following questions:
    1. What output does this produce?               An error.
    2. Why does this happen?                        dogs is undefined.
'''